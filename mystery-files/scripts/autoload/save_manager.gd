...
func save_game() -> void:
	...
	# Stats
	config.set_value("stats", "total_dialogues", StoryManager.stats.total_dialogues)
	config.set_value("stats", "correct_guesses", StoryManager.stats.correct_guesses)
	config.set_value("stats", "play_time", StoryManager.story_progress.play_time)

	# Clues
	config.set_value("clues", "collected", StoryManager.story_progress.collected_clues)
